...
export default function Home() {
  ...
  return (
    <main className="min-h-screen p-4 bg-black text-white flex flex-col h-screen">
      ...
      {/* Game Container */}
      <div className="max-w-2xl mx-auto w-full flex-1 flex flex-col min-h-0 sm:landscape:max-w-[1400px] sm:landscape:grid sm:landscape:grid-cols-[1fr_1px_minmax(350px,35%)] sm:landscape:gap-x-8">
        {/* Game Board Section */}
        <div className="flex flex-col min-h-0">
          ...
          <div className="mb-2 flex justify-center items-center">
            <div className="relative w-[min(400px,85vw)] h-[min(400px,85vw)] sm:landscape:w-[min(400px,50vw)] sm:landscape:h-[min(400px,50vw)]">
              <LetterGrid
                centerLetter={gameState.centerLetter}
                outerLetters={gameState.letters}
        ...
        {/* Vertical Divider - only visible in landscape on larger screens */}
        <div className="hidden sm:landscape:block w-px bg-white/20" />

        {/* Found Words */}
        <div className="pt-2 sm:pt-6 border-t border-white/20 sm:landscape:border-t-0 sm:landscape:pt-4">
          <div className="flex-1 min-h-0 overflow-y-auto max-h-[25vh] sm:max-h-[30vh] sm:landscape:max-h-[85vh]">
            <motion.div 
              layout
              className="flex flex-wrap gap-2 sm:gap-3 justify-center sm:landscape:justify-start p-1 sm:p-4"
            >
